       ...
       <table className="table-moves" style={{width: "100%"}}>
        <tbody>
            ...
            return( <tr key={item.product} style={{textAlign: "center"}}>
             <td style={{paddingTop: "20px"}}><img src={item.photo} style={{width: "90px",height:"100px", float: "left" }} /> {item.title} <CancelIcon onClick={() =>  props.removeFromcart(item)} style={{color: "#2A98EF", marginTop:"40px" }} /> </td>
